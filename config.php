...
function obtenerConexion( ){
	...
	if ($conexion -> connect_errno) {
		responder(null, 
                  true, 
                  "Error al conectar a la base de datos. \nCompruebe los parámetros de la conexión: " . $conexion -> connect_error." Código de error: ".$conexion -> connect_errno, 
                  $conexion );
	}
...
function responder( $datos , $error, $mensaje, $conexion){
    // Formatear el array asocitivo con los campos de respuesta
