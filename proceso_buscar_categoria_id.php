...
if($fila){ 
    ...
    $mensaje = "<h3 class='text-center boldRegularFont'>Categoría Localizada</h3>";
    $mensaje .= "<div class='container' id='listados'><div class='row'><table class='table'>";
    ...
    $mensaje .= "<tbody><tr>";
    $mensaje .= "<td class='text-center'>" . $fila['idcategoria'] . "</td>";
    ...
    $mensaje .= "<form class='d-inline mt-1' action='proceso_borrar_categoria.php' method='post'>";
    ...
    $mensaje .= "</tr></tbody></table></div></div>";
    
} else {
   $mensaje = "<h3 class='text-center'>La categoría con id $idcategoria no está registrada</h3>";
}
